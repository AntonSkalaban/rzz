          ...
          <div className="w-full space-y-2">
            <div className="flex items-center justify-between text-[var(--text-secondary)] text-sm">
              <div className="flex items-top gap-1">
                <Users className="w-4 h-4" style={{ marginTop: "2px" }} />
                <p style={{ minWidth: '70px' }}>
                  <span>{t("raffleDetailModal.participants")}:</span>
                  <span>{raffle.participants}</span>
                </p>
              </div>
              <div className="flex items-top gap-1">
                <Clock className="w-4 h-4" style={{ marginTop: "2px" }} />
                <p style={{ minWidth: '70px' }}>
                  <span>{t("raffleDetailModal.endsIn")}:</span>
              ...
              <ul className="text-[var(--text-secondary)] text-sm space-y-1">
                ...
                {raffle.costToJoin > 0 && (
                  <li className="flex items-center gap-1">
                    • {t("raffleDetailModal.payEntry")}: <TonIcon width={14} height={14} />{" "}
                    {raffle.costToJoin}
                  </li>
                )}
              </ul>
